...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    options = {
        ...
        "substitution": entry.options.get(
        ...
        CONF_APPOINTMENT_THRESHOLD_END: entry.options.get(
            CONF_APPOINTMENT_THRESHOLD_END, DEFAULT_APPOINTMENT_THRESHOLD_END
        ),
        CONF_APPOINTMENT_THRESHOLD_START: entry.options.get(
            CONF_APPOINTMENT_THRESHOLD_START, DEFAULT_APPOINTMENT_THRESHOLD_START
        ),
        CONF_BLACKBOARD_THRESHOLD: entry.options.get(
            CONF_BLACKBOARD_THRESHOLD, DEFAULT_BLACKBOARD_THRESHOLD
        ),
        CONF_LETTER_THRESHOLD: entry.options.get(
            CONF_LETTER_THRESHOLD, DEFAULT_LETTER_THRESHOLD
        ),
        CONF_MESSAGE_THRESHOLD: entry.options.get(
            CONF_MESSAGE_THRESHOLD, DEFAULT_MESSAGE_THRESHOLD
        ),
        CONF_POLL_THRESHOLD: entry.options.get(
            CONF_POLL_THRESHOLD, DEFAULT_POLL_THRESHOLD
        ),
        ...
        CONF_REGISTER_THRESHOLD: entry.options.get(
        ...
        CONF_SICKNOTE_THRESHOLD: entry.options.get(
            CONF_SICKNOTE_THRESHOLD, DEFAULT_SICKNOTE_THRESHOLD
        ),
        CONF_SUBSTITUTION_THRESHOLD: entry.options.get(
